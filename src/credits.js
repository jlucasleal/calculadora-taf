...
export function credits() {
	...
	creditOneLink.href =
		"https://www.flaticon.com/free-icon/trash-can_542724?term=trash+bin&page=1&position=7&origin=search&related_id=542724"
	...
	creditThreeLink.href =
		"https://www.flaticon.com/free-icon/interrogation-mark_5259989"
	...
	creditFiveText.textContent =
		" Em desenvolvimento por 3º Sgt Jorge Lucas - Cia C2 - 9º B Com GE"
	...
	creditFivePlus.addEventListener("click", () => {
		if (!document.querySelector("#credit-five-plus-added")) {
			...
			creditFivePlusAdded.textContent =
				"Qualquer erro, favor enviar email (jorgelucas.leal@eb.mil.br)"
