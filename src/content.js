...
export function makeSquareContent() {
	...
	function makeInfo() {
		if (!document.querySelector("#info")) {
			...
			infoFour.textContent =
				"LEMCT: Linha de Ensino Militar de Científico-Tecnológico"
	...
	const verification = new MakeInput(
		"LEMB Feminino, idade entre 40 e 49?",
		"checkbox",
		"verification",
		"verification",
		"",
